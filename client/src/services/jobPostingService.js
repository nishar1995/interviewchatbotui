...
export async function getJobList() {
    try {
        const response = await axiosInterceptorInstance.get(`http://13.233.184.104:8000/api/job/`, {
            mode: 'no-cors',
            method: 'GET',
            headers: {
...
export async function addJob(data) {
    try {
        console.log(data);
        const response = await axiosInterceptorInstance.post('http://13.233.184.104:8000/api/job/', data);
        return response;
    } catch (error) {
...
export async function updateJob(jobId, data) {
    try {
        console.log(data);
        const response = await axiosInterceptorInstance.put(`http://13.233.184.104:8000/api/job/${jobId}/`, data
        );
        return response;
    } catch (error) {
...
export async function deleteJob(jobId) {
    try {
        const response = await axiosInterceptorInstance.delete(`http://13.233.184.104:8000/api/job/${jobId}/`, {
            method: 'DELETE',
        });
        return response;
