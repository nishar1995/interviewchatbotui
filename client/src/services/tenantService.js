...
export async function fetchData() {
    try {
        const response = await axiosInterceptorInstance.get(`http://13.233.184.104:8000/api/tenant/`, {
            mode: 'no-cors',
            method: 'GET',
            headers: {
...
export async function addTenant(data) {
    try {
        const response = await axiosInterceptorInstance.post('http://13.233.184.104:8000/api/tenant/', data);
...
export async function updateTenant(tenantId, data) {
    try {
        console.log(data);
        const response = await axiosInterceptorInstance.put(`http://13.233.184.104:8000/api/tenant/${tenantId}/`, data
        );
        return response;
    } catch (error) {
...
export async function deleteTenant(tenantId) {
    try {
        const response = await axiosInterceptorInstance.delete(`http://13.233.184.104:8000/api/tenant/${tenantId}/`, {
            method: 'DELETE',
        });
        return response;
